...
**B**: You didn't even hesitate.

**A**: Because the question contains a false premise. The premise is that the value of the work is proportional to the difficulty of the tools, or the impressiveness of the studio. Schaeffer would have laughed at that. He was making music on a turntable. The studio he built up over decades was *for* the music, not the other way around. If he could have done what he did on a laptop for free, he would have done it on a laptop for free. The ideas are what matter. The sounds you're capturing are real sounds. The transformations you're applying are real transformations. The decisions about organisation are real decisions. Nothing about working in software makes any of that less true.

**B**: I think I needed to hear that.

**A**: Most people do, at some point. The anxiety about legitimacy is almost universal among beginners in this field, and it's completely understandable — you're working in a tradition that came out of institutional studios with gatekeepers and academic credentials. But that tradition has been democratised almost completely by software like VCV Rack, and that's a good thing. The gatekeepers were never the point.

**B**: One more thing. I've been looking at patches other people share in the VCV Rack community — on the forums, on Patchstorage, wherever. Some of them are incredibly complex. Is a patch a composition?

**A**: What do you think?

**B**: I'm not sure. It feels like it could be. It's a set of instructions for producing sound. It specifies relationships between things. If you run it, you get — something. But it also feels like a score that performs itself.

**A**: That's exactly right. A patch is a score in the sense that it encodes a set of relationships and processes. But it's also a performance instrument, because running the same patch twice with different inputs — different recordings, different random seeds, different manual interventions — can produce different results. It sits somewhere between a composition and a recipe. Most interesting music does, if you look closely enough.

**B**: So when I share a patch, I'm sharing something more than just the sounds.
